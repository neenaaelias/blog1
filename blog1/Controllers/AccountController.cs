    ...
    public class AccountController : UserController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToAction("UserIndex", "BlogPosts");
        ...
        public async Task<ActionResult> ResendEmailConfirmation(ForgotPasswordViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "confirm your account","Please confirm your account by clicking <a href=\"" + this.callbackUrl + "\">here</a>");
            }
